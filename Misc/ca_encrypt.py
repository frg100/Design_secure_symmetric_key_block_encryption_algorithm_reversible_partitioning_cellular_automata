...
def dispy_margolus1(rule_list,dish):
    ...
    cluster = dispy.JobCluster(update)
...
def generate_key_block(rule_list,generations):
    ...
    dish = initialize(16,bitstring,16)

    dish = evolve(generations,dish,born,survive,print_dish = False,pause = 0)

    entropy = calculate_entropy_of_dish(dish)
